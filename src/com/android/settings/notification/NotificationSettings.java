    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHeadsUpSnoozeTime.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                return Settings.CMREMIX.putInt(getContentResolver(),
        ...
        final int headsUpSnoozeTime = Settings.CMREMIX.getInt(getContentResolver(),
                Settings.CMREMIX.HEADS_UP_SNOOZE_TIME, defaultSnoozeTime);
        ...
        final int headsUpTimeOut = Settings.CMREMIX.getInt(getContentResolver(),
                Settings.CMREMIX.HEADS_UP_NOTIFCATION_DECAY, defaultTimeOut);
