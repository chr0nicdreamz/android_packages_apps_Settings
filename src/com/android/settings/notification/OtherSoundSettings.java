...
import static com.android.settings.notification.SettingPref.TYPE_CMREMIX;
...
import android.provider.Settings.CMREMIX;
...
public class OtherSoundSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final SettingPref PREF_VOLUME_STEPS_ALARM = new SettingPref(
            TYPE_CMREMIX, KEY_VOLUME_STEPS_ALARM, CMREMIX.VOLUME_STEPS_ALARM,
            VOLUME_STEPS_7,
    ...
    private static final SettingPref PREF_VOLUME_STEPS_DTMF = new SettingPref(
            TYPE_CMREMIX, KEY_VOLUME_STEPS_DTMF, CMREMIX.VOLUME_STEPS_DTMF,
            VOLUME_STEPS_15,
            VOLUME_STEPS_5, VOLUME_STEPS_7, VOLUME_STEPS_15,
            VOLUME_STEPS_30, VOLUME_STEPS_45, VOLUME_STEPS_60) {
        @Override
    ...
    private static final SettingPref PREF_VOLUME_STEPS_MUSIC = new SettingPref(
            TYPE_CMREMIX, KEY_VOLUME_STEPS_MUSIC, CMREMIX.VOLUME_STEPS_MUSIC,
            VOLUME_STEPS_15,
            VOLUME_STEPS_5, VOLUME_STEPS_7, VOLUME_STEPS_15,
            VOLUME_STEPS_30, VOLUME_STEPS_45, VOLUME_STEPS_60) {
        @Override
    ...
    private static final SettingPref PREF_VOLUME_STEPS_NOTIFICATION = new SettingPref(
            TYPE_CMREMIX, KEY_VOLUME_STEPS_NOTIFICATION, CMREMIX.VOLUME_STEPS_NOTIFICATION,
            VOLUME_STEPS_7,
            VOLUME_STEPS_5, VOLUME_STEPS_7, VOLUME_STEPS_15,
            VOLUME_STEPS_30, VOLUME_STEPS_45, VOLUME_STEPS_60) {
        @Override
    ...
    private static final SettingPref PREF_VOLUME_STEPS_RING = new SettingPref(
            TYPE_CMREMIX, KEY_VOLUME_STEPS_RING, CMREMIX.VOLUME_STEPS_RING,
            VOLUME_STEPS_7,
            VOLUME_STEPS_5, VOLUME_STEPS_7, VOLUME_STEPS_15,
            VOLUME_STEPS_30, VOLUME_STEPS_45, VOLUME_STEPS_60) {
        @Override
    ...
    private static final SettingPref PREF_VOLUME_STEPS_SYSTEM = new SettingPref(
            TYPE_CMREMIX, KEY_VOLUME_STEPS_SYSTEM, CMREMIX.VOLUME_STEPS_SYSTEM,
            VOLUME_STEPS_7,
            VOLUME_STEPS_5, VOLUME_STEPS_7, VOLUME_STEPS_15,
            VOLUME_STEPS_30, VOLUME_STEPS_45, VOLUME_STEPS_60) {
        @Override
    ...
    private static final SettingPref PREF_VOLUME_STEPS_VOICE_CALL = new SettingPref(
            TYPE_CMREMIX, KEY_VOLUME_STEPS_VOICE_CALL, CMREMIX.VOLUME_STEPS_VOICE_CALL,
            VOLUME_STEPS_5,
            VOLUME_STEPS_5, VOLUME_STEPS_7, VOLUME_STEPS_15,
            VOLUME_STEPS_30, VOLUME_STEPS_45, VOLUME_STEPS_60) {
        @Override
