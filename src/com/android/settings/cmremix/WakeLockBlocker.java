...
public class WakeLockBlocker extends SettingsPreferenceFragment {
    ...
    private boolean isFirstEnable() {
        return Settings.CMREMIX.getString(getActivity().getContentResolver(),
                Settings.CMREMIX.WAKELOCK_BLOCKING_ENABLED) == null;
    }

    private void updateSwitches() {
        mBlockerEnabled.setChecked(Settings.CMREMIX.getInt(getActivity().getContentResolver(),
                Settings.CMREMIX.WAKELOCK_BLOCKING_ENABLED, 0)==1?true:false);
    ...
    private void updateBlockedWakeLocksList() {
        String blockedWakelockList = Settings.CMREMIX.getString(getActivity().getContentResolver(),
    ...
    private void save(){
        ...
        Settings.CMREMIX.putString(getActivity().getContentResolver(),
                Settings.CMREMIX.WAKELOCK_BLOCKING_LIST, buffer.toString());
    }
