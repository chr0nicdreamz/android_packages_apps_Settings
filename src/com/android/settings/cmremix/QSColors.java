...
public class QSColors extends SettingsPreferenceFragment implements
    ...
    public void refreshSettings() {
        ...
        intColor = Settings.CMREMIX.getInt(mResolver,
        ...
        intColor = Settings.CMREMIX.getInt(mResolver,
                Settings.CMREMIX.QS_ICON_COLOR, WHITE);
        ...
        intColor = Settings.CMREMIX.getInt(mResolver,
                Settings.CMREMIX.QS_TEXT_COLOR, WHITE);
        ...
        mQSShadeTransparency.setChecked((Settings.CMREMIX.getInt(mResolver,
        ...
        mQSSSwitch.setChecked((Settings.CMREMIX.getInt(mResolver,
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mQSBackgroundColor) {
            ...
            Settings.CMREMIX.putInt(mResolver,
                Settings.CMREMIX.QS_BACKGROUND_COLOR, intHex);
            ...
            intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.CMREMIX.putInt(mResolver,
                Settings.CMREMIX.QS_ICON_COLOR, intHex);
            preference.setSummary(hex);
            return true;
                ...
                case DLG_RESET:
                    ...
                    .setNeutralButton(R.string.reset_android,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Settings.CMREMIX.putInt(getOwner().mResolver,
                                    Settings.CMREMIX.QS_BACKGROUND_COLOR,
                                    DEFAULT_BACKGROUND_COLOR);
                            Settings.CMREMIX.putInt(getOwner().mResolver,
                                    Settings.CMREMIX.QS_ICON_COLOR, WHITE);
                            Settings.CMREMIX.putInt(getOwner().mResolver,
                                    Settings.CMREMIX.QS_TEXT_COLOR, WHITE);
                            Settings.CMREMIX.putInt(getOwner().mResolver,
                                    Settings.CMREMIX.QS_TRANSPARENT_SHADE, 0);
