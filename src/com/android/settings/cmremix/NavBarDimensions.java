...
public class NavBarDimensions extends SettingsPreferenceFragment implements
    ...
    private void updateDimensionValues() {
        int navigationBarHeight = Settings.CMREMIX.getInt(getContentResolver(),
        ...
        int navigationBarWidth = Settings.CMREMIX.getInt(getContentResolver(),
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mNavigationBarWidth) {
            ...
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.NAVIGATION_BAR_WIDTH,
                    Integer.parseInt(newVal));
            return true;
        } else if (preference == mNavigationBarHeight) {
            String newVal = (String) newValue;
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.NAVIGATION_BAR_HEIGHT,
                    Integer.parseInt(newVal));
            return true;
        }
        return false;
