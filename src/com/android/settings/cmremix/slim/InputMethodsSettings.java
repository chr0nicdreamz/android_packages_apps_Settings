...
public class InputMethodsSettings extends SettingsPreferenceFragment 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDisableFullscreenKeyboard.setChecked(Settings.CMREMIX.getInt(getContentResolver(),
                Settings.CMREMIX.DISABLE_FULLSCREEN_KEYBOARD, 0) == 1);
        ...
        mKeyboardRotationToggle.setChecked(Settings.CMREMIX.getInt(getContentResolver(),
                Settings.CMREMIX.KEYBOARD_ROTATION_TIMEOUT, 0) > 0);
        ...
        updateRotationTimeout(Settings.CMREMIX.getInt(
                getContentResolver(), Settings.CMREMIX.KEYBOARD_ROTATION_TIMEOUT,
                KEYBOARD_ROTATION_TIMEOUT_DEFAULT));

        mShowEnterKey = (SwitchPreference) findPreference(SHOW_ENTER_KEY);
        mShowEnterKey.setChecked(Settings.CMREMIX.getInt(getContentResolver(),
                Settings.CMREMIX.FORMAL_TEXT_INPUT, 0) == 1);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mDisableFullscreenKeyboard) {
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.DISABLE_FULLSCREEN_KEYBOARD,  (Boolean) objValue ? 1 : 0);
            return true;
            ...
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.KEYBOARD_ROTATION_TIMEOUT,
            ...
            Settings.CMREMIX.putInt(getContentResolver(),
                Settings.CMREMIX.FORMAL_TEXT_INPUT, (Boolean) objValue ? 1 : 0);
            return true;
        } else if (preference == mKeyboardRotationTimeout) {
            int timeout = Integer.parseInt((String) objValue);
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.KEYBOARD_ROTATION_TIMEOUT, timeout);
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
            ...
            sir.xmlResId = R.xml.input_methods_settings;
            result.add(sir);
