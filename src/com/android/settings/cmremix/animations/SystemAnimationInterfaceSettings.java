...
public class SystemAnimationInterfaceSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAnimNoOverride.setChecked(Settings.CMREMIX.getInt(mResolver,
                Settings.CMREMIX.ANIMATION_CONTROLS_NO_OVERRIDE, 0) == 1);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mAnimNoOverride) {
            ...
            Settings.CMREMIX.putInt(mResolver, Settings.CMREMIX.ANIMATION_CONTROLS_NO_OVERRIDE, value ? 1 : 0);
