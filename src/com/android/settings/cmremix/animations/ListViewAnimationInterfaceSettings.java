...
public class ListViewAnimationInterfaceSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int listviewDuration = Settings.CMREMIX.getInt(mResolver,
                Settings.CMREMIX.LISTVIEW_DURATION, 0);
    ...
    private void setProperVal(Preference preference, int val) {
        ...
        Settings.CMREMIX.putInt(mContext.getContentResolver(), mString, val);
    }
    ...
    private String getProperVal(Preference preference) {
        ...
        return Settings.CMREMIX.getString(mContext.getContentResolver(), mString);
    }
