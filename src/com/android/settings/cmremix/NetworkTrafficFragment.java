...
public class NetworkTrafficFragment extends SettingsPreferenceFragment 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.cmremix_network_traffic_settings);
        ...
        int intColor = Settings.CMREMIX.getInt(getContentResolver(),
        ...
        mNetTrafficAutohide.setChecked((Settings.CMREMIX.getInt(getContentResolver(),
                Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_AUTOHIDE, 0) == 1));
        ...
        if (TrafficStats.getTotalTxBytes() != TrafficStats.UNSUPPORTED &&
            ...
            mNetTrafficVal = Settings.CMREMIX.getInt(getContentResolver(),
                    Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_STATE, defaultState);
    ...
    private void NetworkTrafficColorReset() {
        Settings.CMREMIX.putInt(getContentResolver(),
                Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_COLOR, DEFAULT_TRAFFIC_COLOR);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mNetTrafficDisplay) {
            ...
            Settings.CMREMIX.putInt(getActivity().getContentResolver(),
                    Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_STATE, mNetTrafficVal);
            ...
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_COLOR, intHex);
            return true;  
            ...
            Settings.CMREMIX.putInt(getActivity().getContentResolver(),
                    Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_AUTOHIDE, value ? 1 : 0);
            return true;
        } else if (preference == mNetTrafficAutohideThreshold) {
            int threshold = (Integer) newValue;
            Settings.CMREMIX.putInt(getActivity().getContentResolver(),
                    Settings.CMREMIX.NETWORK_TRAFFIC_VECTOR_AUTOHIDE_THRESHOLD, threshold);
            return true;
        }
        return false;
    }
