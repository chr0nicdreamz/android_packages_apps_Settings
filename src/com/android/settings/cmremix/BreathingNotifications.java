...
public class BreathingNotifications extends SettingsPreferenceFragment implements
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mSMSBreath) {
            ...
            Settings.CMREMIX.putInt(resolver, Settings.CMREMIX.KEY_SMS_BREATH, value ? 1 : 0);
        } else if (preference == mMissedCallBreath) {
            boolean value = (Boolean) objValue;
            Settings.CMREMIX.putInt(resolver, Settings.CMREMIX.KEY_MISSED_CALL_BREATH, value ? 1 : 0);
        } else if (preference == mVoicemailBreath) {
            boolean value = (Boolean) objValue;
            Settings.CMREMIX.putInt(resolver, Settings.CMREMIX.KEY_VOICEMAIL_BREATH, value ? 1 : 0);
        } else {
            return false;
        }
