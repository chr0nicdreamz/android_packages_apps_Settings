...
import com.android.settings.cmremix.gestureanywhere.ShortcutPickHelper;
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case REQUEST_NEW_GESTURE:
                    Settings.CMREMIX.putLong(getContentResolver(),
                            Settings.CMREMIX.GESTURE_ANYWHERE_CHANGED,
