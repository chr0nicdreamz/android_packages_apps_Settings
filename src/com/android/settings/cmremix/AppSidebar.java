...
public class AppSidebar extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHideLabelsPref.setChecked((Settings.CMREMIX.getInt(getContentResolver(),
                Settings.CMREMIX.APP_SIDEBAR_DISABLE_LABELS, 0) == 1));

        PreferenceScreen prefSet = getPreferenceScreen();
        mPositionPref = (ListPreference) prefSet.findPreference(KEY_POSITION);
        mPositionPref.setOnPreferenceChangeListener(this);
        int position = Settings.CMREMIX.getInt(getContentResolver(), Settings.CMREMIX.APP_SIDEBAR_POSITION, 0);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mTransparencyPref) {
            ...
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.APP_SIDEBAR_TRANSPARENCY, transparency);
            return true;
        } else if (preference == mTriggerWidthPref) {
            int width = ((Integer)newValue).intValue();
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.APP_SIDEBAR_TRIGGER_WIDTH, width);
            return true;
        } else if (preference == mTriggerTopPref) {
            int top = ((Integer)newValue).intValue();
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.APP_SIDEBAR_TRIGGER_TOP, top);
            return true;
        } else if (preference == mTriggerBottomPref) {
            int bottom = ((Integer)newValue).intValue();
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.APP_SIDEBAR_TRIGGER_HEIGHT, bottom);
            return true;
            ...
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.APP_SIDEBAR_ENABLED,
                    value ? 1 : 0);
            return true;
        }
        return false;
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mHideLabelsPref) {
            ...
            Settings.CMREMIX.putInt(getContentResolver(),
                    Settings.CMREMIX.APP_SIDEBAR_DISABLE_LABELS,
                    value ? 1 : 0);
        } else {
    ...
    private void updatePositionSummary(int value) {
        ...
        Settings.CMREMIX.putInt(getContentResolver(),
                Settings.CMREMIX.APP_SIDEBAR_POSITION, value);
    }
    ...
    public void onPause() {
        super.onPause();
        Settings.CMREMIX.putInt(getContentResolver(),
                Settings.CMREMIX.APP_SIDEBAR_SHOW_TRIGGER, 0);
    }
