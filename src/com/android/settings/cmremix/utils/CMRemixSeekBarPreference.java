...
public class CMRemixSeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    public CMRemixSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPreference(context, attrs);
    }

    public CMRemixSeekBarPreference(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * Update a CMRemixSeekBarPreference view with our current state
     * @param view
     */
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (mCurrentValue == mDefaultValue && mDefaultValue != -1)
            mStatusText.setText(R.string.seekbar_default);
        else
