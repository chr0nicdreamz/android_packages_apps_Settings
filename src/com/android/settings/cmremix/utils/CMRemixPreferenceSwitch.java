/*
 * Copyright (C) 2014 CMRemix Roms && The Android Open Source Project
 *
...
public class CMRemixPreferenceSwitch extends Preference implements OnCheckedChangeListener {

    private static final String TAG = "CMRemixPreferenceSwitch";

    private Switch mSwitch;
    private String mSetting = null;
    private int mDefault = 0;

    public CMRemixPreferenceSwitch(Context context) {
        super(context);
    }

    public CMRemixPreferenceSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CMRemixPreferenceSwitch(Context context, AttributeSet attrs, int defStyle) {
