...
package com.android.settings.cmremix.hfm;
...
import com.android.settings.cmremix.hfm.HfmSettings;
...
public final class HfmHelpers {
    ...
    public static void checkStatus(Context context) {
        ...
        try {
            if (Settings.CMREMIX.getInt(context.getContentResolver(), Settings.CMREMIX.HFM_DISABLE_ADS, 0) == 1
                    && areFilesDifferent(hosts, altHosts)) {
                copyFiles(altHosts, hosts);
            } else if (Settings.CMREMIX.getInt(context.getContentResolver(), Settings.CMREMIX.HFM_DISABLE_ADS, 0) == 0
