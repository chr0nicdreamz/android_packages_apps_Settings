...
public class FlashNotifications extends SettingsPreferenceFragment implements
    ...
    private SwitchPreference mPocketModePref;
    private SwitchPreference mAllowLowPriority;
    private SwitchPreference mAllowNonClearable;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPocketModePref = (SwitchPreference) prefs.findPreference(KEY_POCKET_MODE);
        ...
        mAllowLowPriority = (SwitchPreference) prefs.findPreference(KEY_LOW_PRIORITY);
        mAllowLowPriority.setChecked(Settings.System.getInt(cr,
                    Settings.System.FLASH_NOTIFICATIONS_LOW_PRIORITY, 0) == 1);

        mAllowNonClearable = (SwitchPreference) prefs.findPreference(KEY_NON_CLEARABLE);
