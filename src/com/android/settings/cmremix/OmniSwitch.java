...
public class OmniSwitch extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.cmremix_omniswitch);
        ...
        try {
            mRecentsUseOmniSwitch.setChecked(Settings.CMREMIX.getInt(resolver,
                    Settings.CMREMIX.RECENTS_USE_OMNISWITCH) == 1);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mRecentsUseOmniSwitch) {
            ...
            Settings.CMREMIX.putInt(
                    resolver, Settings.CMREMIX.RECENTS_USE_OMNISWITCH, value ? 1 : 0);
